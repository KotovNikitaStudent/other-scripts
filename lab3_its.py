...
class Statistics:
    ...
    def print(self):
        ...
        print(f' 4) Среднее количество занятых каналов = {self.avr_len_task.get()}')
        ...
        print(f' 7) Среднее время ожидания заявки в очереди = {self.avr_time_task.get()}')
        print(f' 8) Среднее время обслуживания заявки = {self.avr_time_in_serv.get()}')
        print(f' 9) Среднее время нахождения заявки в системе = {self.avr_task_in_sistem.get()}')
        print(f' 10) Среднее количество заявок в системе = {len_queue + self.n_serv/(self.n_serv + self.n_rej)}')
